...
export default function Report() {
  ...
  useEffect(() => {
    if (sessionId) {
      ...
      setData(ctxReport)
      // For fresh sessions: the backend returns session_id in the report payload.
      // Use it to immediately fetch the normative population comparison
      // (PSI = Psychomotor Slowing Index; PAI = Psychomotor Agitation Index).
