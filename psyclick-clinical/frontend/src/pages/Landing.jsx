...
const featureCards = [
  ...
  },
  {
    ...
    text: 'Uses 12 written prompts across emotional domains to observe response rhythm, hesitation, and psychomotor shifts.',
  },
  {
    icon: BarChart3,
    ...
    <main className="landing-page">
      ...
      <section id="guide" className="guide-section">
        <div className="guide-copy">
          ...
          <p>
            Clinicians lead the workflow — clients complete guided tasks while PsyClick captures psychomotor biomarkers in the background.
          </p>
        </div>
